...
import 'package:ryde_app/Assistants/requestAssistant.dart';
import 'package:ryde_app/DataHandler/appData.dart';
import 'package:ryde_app/Models/address.dart';
...
class AssistantMethods
{
  ...
  {
    //in terms USD
    double timeTraveledFare = (directionDetails.durationValue / 60) * 0.14;
    double distanceTraveledFare = (directionDetails.distanceValue / 1000) * 0.65; //1.25
    double serviceFee = 2.55;
    double basePay = 5;
    double totalFareAmount = timeTraveledFare + distanceTraveledFare + basePay + serviceFee;
